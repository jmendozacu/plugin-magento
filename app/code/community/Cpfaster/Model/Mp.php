...
class Cpfaster_Model_Mp extends Mage_Payment_Model_Method_Abstract
{
    //put your code here
...
//       } 
         ...
         public function DoPost($fields,$url,$heads,$codeexpect,$type,$method){
               ...
               echo('The comunication with ComproPago has fail, if you are the site owner turn on DebugMode to see the error');
               endif;
              //  $this->debug($status);
                return false;
                } else {
        ...
        public function getAccessToken(){
            ...
            // get the clients variables
                ...
                $url = 'https://api.compropago.com/oauth/token';

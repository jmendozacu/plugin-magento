...
class Cpfaster_Block_Information_Success extends Mage_Core_Block_Template

{
    protected $_order = null;
    protected $_id = null;
    protected $_address = null;
    protected $_editpage = 'cpfaster/information/address/';
    protected $_home = '';

    protected function _beforeToHtml()
    {  
       $mpid = Mage::getSingleton('customer/session')->getMpCartId();
       $mpcart = Mage::getModel('cpfaster/mpcart')->load($mpid);

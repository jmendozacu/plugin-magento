...
class Cpfaster_Block_Information_Form extends Mage_Core_Block_Template

{
    protected $_postpage = 'cpfaster/information/post';
   ...
   //  $countryName = Mage::getModel('directory/country')->getName();//get country name
       ...
       $this->_mpcart = Mage::getModel('cpfaster/mpcart')->load($this->_id);
       ...
       $this->_cepachage =  Mage::getModel('cpfaster/faster')->getConfigData('change_postalcode');
